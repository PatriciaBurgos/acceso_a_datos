...
import terceraentrega_ad.Biblioteca;
import terceraentrega_ad.Libro;
import terceraentrega_ad.Persona;

/**
 *
 * @author Patricia Burgos
 */
public class test_tercera_entrega {
    
    public test_tercera_entrega() {
    }
